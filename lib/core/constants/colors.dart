...
class AppColors {
  ...
  static const Color busScheduleHighlightDark = Color(
    0xFF1A237E,
  ); // Deep indigo
  static const Color busScheduleHighlight = Color(0xFF3F51B5); // Indigo
  static const Color busScheduleHighlightLight = Color(
    0xFFE8EAF6,
  ); // Light indigo
  static const Color busScheduleHighlightTextLight = Color(
    0xFF00D9A7,

    // #00d9a7
  ); // Indigo text
  static const Color busScheduleHighlightTextDark = Color(
    0xFF009688,
  ); // Light indigo text
